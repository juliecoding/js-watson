angular.module('watsonApp').service('mainService', function($http) {
    ...
    function compare(profile1, profile2) {
        compared_data = {};
        for (var prop in profile1) {
            compared_data[prop] = Math.abs(profile1[prop] - profile2[prop]);
        }
        return compared_data;
    }
    ...
    // function obnoxious(str) {
    //     var better = str.replace(/^u'/g, '');
    //     console.log(better);
    // }
    ...
    var crazyTown = compare(me, trump);
    ...
    function sortStart(obj) {
        ...
        workableArray.sort(function(a, b) {
            return a[1] - b[1];
        });
